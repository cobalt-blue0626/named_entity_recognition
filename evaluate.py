...
from utils import load_model, extend_maps, prepocess_data_for_lstmcrf,loadDevFile,Dev_CRFFormatData,output_pred, flatten_lists,save_model
...
def hmm_train_eval(train_data, test_word_lists, word2id, tag2id, remove_O=False):
    """训练并评估hmm模型"""
    # 训练HMM模型
...
def bilstm_train_and_eval(train_data, dev_data, test_word_lists,
